...
namespace InterprocessMemory
{
    ...
    public readonly struct FieldDefinition
    {
        ...
        public static FieldDefinition Utf8String(string name, int maxByteLength)
        {
            ...
            {
                Name = name,
                TypeCode = FieldTypeCode.Utf8String,
                ElementSize = 1,
        ...
        private static readonly Dictionary<Type, FieldTypeCode> s_typeCodes = new(18)
        {
            [typeof(bool)] = FieldTypeCode.Boolean,
            [typeof(byte)] = FieldTypeCode.Byte,
            [typeof(sbyte)] = FieldTypeCode.SByte,
            [typeof(char)] = FieldTypeCode.Char,
            [typeof(short)] = FieldTypeCode.Int16,
            [typeof(ushort)] = FieldTypeCode.UInt16,
            [typeof(int)] = FieldTypeCode.Int32,
            [typeof(uint)] = FieldTypeCode.UInt32,
            [typeof(long)] = FieldTypeCode.Int64,
            [typeof(ulong)] = FieldTypeCode.UInt64,
            [typeof(float)] = FieldTypeCode.Single,
            [typeof(double)] = FieldTypeCode.Double,
            [typeof(decimal)] = FieldTypeCode.Decimal,
            [typeof(Guid)] = FieldTypeCode.Guid,
            [typeof(DateTime)] = FieldTypeCode.DateTime,
            [typeof(TimeSpan)] = FieldTypeCode.TimeSpan,
            [typeof(DateTimeOffset)] = FieldTypeCode.DateTimeOffset,
        };

        internal static FieldTypeCode GetTypeCode<T>() where T : unmanaged
        {
        ...
        private static FieldTypeCode ResolveTypeCode(Type type)
        {
            ...
            if (type.IsEnum)
            {
                ...
                return s_typeCodes.TryGetValue(underlying, out code) ? code : FieldTypeCode.Unknown;
            }

            // Custom unmanaged struct
            if (type.IsValueType && !type.IsPrimitive)
                return FieldTypeCode.Struct;
        ...
        {
            internal static readonly FieldTypeCode Value = ResolveTypeCode(typeof(T));
        }
    }
}
