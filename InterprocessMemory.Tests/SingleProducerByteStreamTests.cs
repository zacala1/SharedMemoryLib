...
[TestFixture]
public class SingleProducerByteStreamTests
{
    ...
    {
        using var buffer = new SingleProducerByteStream(TestBufferName + "_Create", 4096);
    ...
    {
        using var buffer = new SingleProducerByteStream(TestBufferName + "_Single", 4096);
    ...
    {
        using var buffer = new SingleProducerByteStream(TestBufferName + "_Full", 128);
    ...
    {
        using var buffer = new SingleProducerByteStream(TestBufferName + "_BufferFull", 256);
    ...
    {
        using var buffer = new SingleProducerByteStream(TestBufferName + "_Empty", 4096);
    ...
    {
        using var buffer = new SingleProducerByteStream(TestBufferName + "_FIFO", 4096);
    ...
    {
        using var buffer = new SingleProducerByteStream(TestBufferName + "_Available", 4096);
    ...
    {
        using var buffer = new SingleProducerByteStream(TestBufferName + "_Used", 4096);
    ...
    {
        using var buffer = new SingleProducerByteStream(TestBufferName + "_Stats", 4096);
    ...
    {
        using var buffer = new SingleProducerByteStream(TestBufferName + "_Wrap", 512);
    ...
    {
        using var buffer = new SingleProducerByteStream(TestBufferName + "_SPSC", 64 * 1024);
    ...
    {
        using var buffer = new SingleProducerByteStream(TestBufferName + "_Variable", 4096);
    ...
    {
        var buffer = new SingleProducerByteStream(TestBufferName + "_Dispose", 4096);
        buffer.Dispose();
