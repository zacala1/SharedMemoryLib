...
public class ConcurrentMessageQueueTests
{
    ...
    {
        using var buffer = new ConcurrentMessageQueue(GetUniqueName("Create"), slotCount: 16, slotSize: 64);
    ...
    {
        using var buffer = new ConcurrentMessageQueue(GetUniqueName("PowerOf2"), slotCount: 10, slotSize: 64);
    ...
    {
        using var buffer = new ConcurrentMessageQueue(GetUniqueName("Single"), slotCount: 16, slotSize: 64);
    ...
    {
        using var buffer = new ConcurrentMessageQueue(GetUniqueName("ExceedsMax"), slotCount: 16, slotSize: 32);
    ...
    {
        using var buffer = new ConcurrentMessageQueue(GetUniqueName("Empty"), slotCount: 16, slotSize: 64);
    ...
    {
        using var buffer = new ConcurrentMessageQueue(GetUniqueName("Full"), slotCount: 4, slotSize: 64);
    ...
    {
        using var buffer = new ConcurrentMessageQueue(GetUniqueName("FIFO"), slotCount: 32, slotSize: 64);
    ...
    {
        using var buffer = new ConcurrentMessageQueue(GetUniqueName("Stats"), slotCount: 16, slotSize: 64);
    ...
    {
        using var buffer = new ConcurrentMessageQueue(GetUniqueName("Count"), slotCount: 16, slotSize: 64);
    ...
    {
        using var buffer = new ConcurrentMessageQueue(GetUniqueName("Available"), slotCount: 8, slotSize: 64);
    ...
    {
        using var buffer = new ConcurrentMessageQueue(GetUniqueName("WaitWrite"), slotCount: 16, slotSize: 64);
    ...
    {
        using var buffer = new ConcurrentMessageQueue(GetUniqueName("WaitRead"), slotCount: 16, slotSize: 64);
    ...
    {
        using var buffer = new ConcurrentMessageQueue(GetUniqueName("WaitTimeout"), slotCount: 16, slotSize: 64);
    ...
    {
        using var buffer = new ConcurrentMessageQueue(GetUniqueName("MPSC"), slotCount: 1024, slotSize: 64);
    ...
    {
        using var buffer = new ConcurrentMessageQueue(GetUniqueName("SPMC"), slotCount: 1024, slotSize: 64);
    ...
    {
        using var buffer = new ConcurrentMessageQueue(GetUniqueName("MPMC_Stress"), slotCount: 256, slotSize: 64);
    ...
    {
        var buffer = new ConcurrentMessageQueue(GetUniqueName("Dispose"), slotCount: 16, slotSize: 64);
        buffer.Dispose();
    ...
    {
        var buffer = new ConcurrentMessageQueue(GetUniqueName("DisposedAccess"), slotCount: 16, slotSize: 64);
        buffer.Dispose();
    ...
    {
        Assert.Throws<ArgumentException>(() => new ConcurrentMessageQueue(null!, slotCount: 16, slotSize: 64));
    }

    [Test]
    public void Constructor_EmptyName_ShouldThrow()
    {
        Assert.Throws<ArgumentException>(() => new ConcurrentMessageQueue("", slotCount: 16, slotSize: 64));
    }
    ...
    public void Constructor_ZeroSlotCount_ShouldThrow()
    {
        Assert.Throws<ArgumentOutOfRangeException>(() =>
            new ConcurrentMessageQueue(GetUniqueName("Zero"), slotCount: 0, slotSize: 64));
    }
    ...
    {
        Assert.Throws<ArgumentOutOfRangeException>(() =>
            new ConcurrentMessageQueue(GetUniqueName("Negative"), slotCount: -1, slotSize: 64));
    }
    ...
    public void Constructor_SlotSizeTooSmall_ShouldThrow()
    {
        ...
        Assert.Throws<ArgumentOutOfRangeException>(() =>
            new ConcurrentMessageQueue(GetUniqueName("TooSmall"), slotCount: 16, slotSize: 16));
    }
