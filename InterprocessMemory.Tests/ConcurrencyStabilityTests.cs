...
public class ConcurrencyStabilityTests
{
    ...
    public async Task Opt7_StatsDisabled_HighContentionReaders_NoCorruption()
    {
        ...
        var opts = new MemoryRegionOptions { Capacity = 16 * 1024, EnableStatistics = false };
        using var buf = new MemoryRegion(N("Opt7Stress"), opts);
    ...
    public async Task Opt8_OptimisticReader_64Readers_4Writers_AllProgress()
    {
        ...
        using var buf = new MemoryRegion(N("Opt8Stress"),
    ...
    public async Task StabilityA_OrphanCheckUnderLegitimateLockUse_NoFalsePositive()
    {
        ...
        using var buf = new MemoryRegion(N("StabAStress"),
    ...
    public async Task Stability_SPSC_2Minutes_OrderPreserved()
    {
        ...
        using var buf = new SingleProducerByteStream(N("Stab_SPSC_2m"), 1024 * 1024);
    ...
    // ── Long-running StructuredMemory mixed access ─────────────────────────
    ...
    public async Task Stability_Strict_2Minutes_MixedAccessNoLockLeak()
    {
        ...
        using var mem = new StructuredMemory<MixedSchema>(N("Stab_Strict_2m"), new MixedSchema());
    ...
    public async Task Fairness_WriterUnderModerateReaders_MakesProgress()
    {
        ...
        using var buf = new MemoryRegion(N("FairnessMod"),
            new MemoryRegionOptions { Capacity = 4096 });
    ...
    public async Task Fairness_Mpmc_ProducersGetReasonableShare()
    {
        ...
        using var buf = new ConcurrentMessageQueue(N("FairProd"), slotCount: 256, slotSize: 128);
    ...
    private struct MixedSchema : IMemorySchema
    {
