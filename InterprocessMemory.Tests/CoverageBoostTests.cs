...
public class CoverageBoostTests
{
    ...
    #region MemoryRegionOptions.Validate Coverage

    [Test]
    public void Validate_NegativeCapacity_ShouldThrow()
    {
        var options = new MemoryRegionOptions { Capacity = -1 };
    ...
    {
        var options = new MemoryRegionOptions { Capacity = 0 };
        Assert.Throws<ArgumentOutOfRangeException>(() => options.Validate());
    }
    ...
    public void WriteLock_Reentrant_ShouldNotDeadlock()
    {
        ...
        using var memory = new StructuredMemory<ReentrantTestSchema>("CovBoost_Reentrant_Write", schema);
    ...
    {
        var schema = new ReentrantTestSchema();
        using var memory = new StructuredMemory<ReentrantTestSchema>("CovBoost_Reentrant_Read", schema);
    ...
    {
        var schema = new ReentrantTestSchema();
        using var memory = new StructuredMemory<ReentrantTestSchema>("CovBoost_ReadUnderWrite", schema);
    ...
    [Test]
    public void SingleProducerByteStream_HugeCapacity_ShouldThrow()
    {
        // After power-of-2 rounding + header, total exceeds int.MaxValue
        Assert.Throws<ArgumentOutOfRangeException>(() =>
            new SingleProducerByteStream("CovBoost_Overflow_SPSC", int.MaxValue));
    }

    [Test]
    public void ConcurrentMessageQueue_HugeSlotCount_ShouldThrow()
    {
        // Large slotCount * slotSize will exceed int.MaxValue
        Assert.Throws<ArgumentOutOfRangeException>(() =>
            new ConcurrentMessageQueue("CovBoost_Overflow_MPMC", int.MaxValue / 2, 64));
    }
    ...
    public void OnDataWritten_HandlerThrows_ShouldNotAffectWrite()
    {
        ...
        using var buffer = new MemoryRegion("CovBoost_EventException", options);
    ...
    {
        var options = new MemoryRegionOptions { Capacity = 4096 };
        using var buffer = new MemoryRegion("CovBoost_AsyncCancel_W", options);
    ...
    {
        var options = new MemoryRegionOptions { Capacity = 4096 };
        using var buffer = new MemoryRegion("CovBoost_AsyncCancel_R", options);
    ...
    {
        var options = new MemoryRegionOptions { Capacity = 100 };
        using var buffer = new MemoryRegion("CovBoost_AsyncExc_W", options);
    ...
    {
        var options = new MemoryRegionOptions { Capacity = 100 };
        using var buffer = new MemoryRegion("CovBoost_AsyncExc_R", options);
    ...
    [Test]
    public void SingleProducerByteStream_WaitWrite_Timeout_ShouldReturnFalse()
    {
        using var buffer = new SingleProducerByteStream("CovBoost_WaitWrite", 256);
    ...
    [Test]
    public void SingleProducerByteStream_WaitRead_Timeout_ShouldReturnZero()
    {
        using var buffer = new SingleProducerByteStream("CovBoost_WaitRead", 256);
    ...
    [Test]
    public void ConcurrentMessageQueue_WaitWrite_Timeout_ShouldReturnFalse()
    {
        using var buffer = new ConcurrentMessageQueue("CovBoost_MpmcWaitWrite", 4, 64);
    ...
    [Test]
    public void ConcurrentMessageQueue_WaitRead_Timeout_ShouldReturnZero()
    {
        using var buffer = new ConcurrentMessageQueue("CovBoost_MpmcWaitRead", 4, 64);
    ...
    public void FileBacked_Create_WriteRead_ShouldRoundTrip()
    {
        ...
        try
        {
            ...
            using var buffer = new MemoryRegion("CovBoost_FileBacked", options);
    ...
    public void WriteRead_LargeString_ShouldUseArrayPoolPath()
    {
        ...
        using var memory = new StructuredMemory<LargeStringSchema>("CovBoost_LargeString", schema);
    ...
    {
        var schema = new LargeStringSchema();
        using var memory = new StructuredMemory<LargeStringSchema>("CovBoost_LargeStringEmpty", schema);
    ...
    {
        var v1 = new SchemaV1();
        using var mem1 = new StructuredMemory<SchemaV1>(
        ...
        Assert.Throws<InvalidOperationException>(() =>
            new StructuredMemory<SchemaV2>("CovBoost_SchemaStrict", v2, false, SchemaCompatibility.Strict));
    }
    ...
    {
        var v2 = new SchemaV2();
        using var mem2 = new StructuredMemory<SchemaV2>(
    ...
    public void Schema_Forward_OlderVersion_ShouldThrow()
    {
        ...
        var v2 = new SchemaV2();
        Assert.Throws<InvalidOperationException>(() =>
            new StructuredMemory<SchemaV2>("CovBoost_SchemaFwdFail", v2, false, SchemaCompatibility.Forward));
    }
    ...
    public void Schema_Backward_NewerVersion_ShouldThrow()
    {
        ...
        var v1 = new SchemaV1();
        Assert.Throws<InvalidOperationException>(() =>
            new StructuredMemory<SchemaV1>("CovBoost_SchemaBwdFail", v1, false, SchemaCompatibility.Backward));
    }
    ...
    public void FieldDefinition_SByte_ShouldReturnCorrectTypeCode()
    {
        ...
        Assert.That(field.TypeCode, Is.EqualTo(FieldTypeCode.SByte));
    }
    ...
    public void FieldDefinition_Char_ShouldReturnCorrectTypeCode()
    {
        ...
        Assert.That(field.TypeCode, Is.EqualTo(FieldTypeCode.Char));
    }
    ...
    public void FieldDefinition_UShort_ShouldReturnCorrectTypeCode()
    {
        ...
        Assert.That(field.TypeCode, Is.EqualTo(FieldTypeCode.UInt16));
    }
    ...
    public void FieldDefinition_UInt_ShouldReturnCorrectTypeCode()
    {
        ...
        Assert.That(field.TypeCode, Is.EqualTo(FieldTypeCode.UInt32));
    }
    ...
    public void FieldDefinition_ULong_ShouldReturnCorrectTypeCode()
    {
        ...
        Assert.That(field.TypeCode, Is.EqualTo(FieldTypeCode.UInt64));
    }
    ...
    public void FieldDefinition_Decimal_ShouldReturnCorrectTypeCode()
    {
        ...
        Assert.That(field.TypeCode, Is.EqualTo(FieldTypeCode.Decimal));
    }
    ...
    public void FieldDefinition_Guid_ShouldReturnCorrectTypeCode()
    {
        ...
        Assert.That(field.TypeCode, Is.EqualTo(FieldTypeCode.Guid));
    }
    ...
    public void FieldDefinition_DateTime_ShouldReturnCorrectTypeCode()
    {
        ...
        Assert.That(field.TypeCode, Is.EqualTo(FieldTypeCode.DateTime));
    }
    ...
    public void FieldDefinition_TimeSpan_ShouldReturnCorrectTypeCode()
    {
        ...
        Assert.That(field.TypeCode, Is.EqualTo(FieldTypeCode.TimeSpan));
    }
    ...
    public void FieldDefinition_DateTimeOffset_ShouldReturnCorrectTypeCode()
    {
        ...
        Assert.That(field.TypeCode, Is.EqualTo(FieldTypeCode.DateTimeOffset));
    }
    ...
    public void FieldDefinition_Struct_ShouldReturnStructTypeCode()
    {
        ...
        Assert.That(field.TypeCode, Is.EqualTo(FieldTypeCode.Struct));
    ...
    {
        Assert.That(FieldDefinition.Scalar<TestByteEnum>("e").TypeCode, Is.EqualTo(FieldTypeCode.Byte));
        Assert.That(FieldDefinition.Scalar<TestShortEnum>("e").TypeCode, Is.EqualTo(FieldTypeCode.Int16));
        Assert.That(FieldDefinition.Scalar<TestLongEnum>("e").TypeCode, Is.EqualTo(FieldTypeCode.Int64));
        Assert.That(FieldDefinition.Scalar<TestUIntEnum>("e").TypeCode, Is.EqualTo(FieldTypeCode.UInt32));
        Assert.That(FieldDefinition.Scalar<TestUShortEnum>("e").TypeCode, Is.EqualTo(FieldTypeCode.UInt16));
        Assert.That(FieldDefinition.Scalar<TestULongEnum>("e").TypeCode, Is.EqualTo(FieldTypeCode.UInt64));
        Assert.That(FieldDefinition.Scalar<TestSByteEnum>("e").TypeCode, Is.EqualTo(FieldTypeCode.SByte));
    }
    ...
    public void IsWriteLockOrphaned_WhenNoLockHeld_ShouldReturnFalse()
    {
        ...
        using var buffer = new MemoryRegion("CovBoost_OrphanNoLock", options);
    ...
    public void TryForceRelease_WhenNoLock_ShouldReturnFalse()
    {
        ...
        using var buffer = new MemoryRegion("CovBoost_ForceNoLock", options);
    ...
    {
        var options = new MemoryRegionOptions { Capacity = 4096 };
        using var buffer = new MemoryRegion("CovBoost_OwnerNoLock", options);
    ...
    #region StructuredMemory Edge Cases

    [Test]
    public void HasField_ExistingField_ShouldReturnTrue()
    {
        var schema = new ReentrantTestSchema();
        using var memory = new StructuredMemory<ReentrantTestSchema>("CovBoost_HasField", schema);
    ...
    {
        var schema = new ReentrantTestSchema();
        using var memory = new StructuredMemory<ReentrantTestSchema>("CovBoost_FieldNames", schema);
    ...
    {
        var schema = new ReentrantTestSchema();
        using var memory = new StructuredMemory<ReentrantTestSchema>("CovBoost_ReadInvalid", schema);
    ...
    {
        var schema = new ReentrantTestSchema();
        using var memory = new StructuredMemory<ReentrantTestSchema>("CovBoost_ArrayOnScalar", schema);
    ...
    {
        var schema = new ReentrantTestSchema();
        using var memory = new StructuredMemory<ReentrantTestSchema>("CovBoost_ReadArrayOnScalar", schema);
    ...
    {
        var schema = new ReentrantTestSchema();
        using var memory = new StructuredMemory<ReentrantTestSchema>("CovBoost_StringOnScalar", schema);
    ...
    {
        var schema = new ReentrantTestSchema();
        using var memory = new StructuredMemory<ReentrantTestSchema>("CovBoost_ReadStringOnScalar", schema);
    ...
    {
        var schema = new ReentrantTestSchema();
        using var memory = new StructuredMemory<ReentrantTestSchema>("CovBoost_NullString", schema);
    ...
    public void WriteArray_ExceedsCapacity_ShouldThrow()
    {
        ...
        using var memory = new StructuredMemory<ArraySchema>("CovBoost_ArrayOverflow", schema);
    ...
    {
        var schema = new ArraySchema();
        using var memory = new StructuredMemory<ArraySchema>("CovBoost_ReadArrayOverflow", schema);
    ...
    {
        var schema = new ReentrantTestSchema();
        using var memory = new StructuredMemory<ReentrantTestSchema>("CovBoost_LockTimeout", schema);
    ...
    {
        var schema = new ReentrantTestSchema();
        using var memory = new StructuredMemory<ReentrantTestSchema>("CovBoost_ReadLockTimeout", schema);
    ...
    {
        var schema = new ReentrantTestSchema();
        var memory = new StructuredMemory<ReentrantTestSchema>("CovBoost_Disposed", schema);
        memory.Dispose();
    ...
    [Test]
    public void MemoryRegion_EmptyName_ShouldThrow()
    {
        var options = new MemoryRegionOptions { Capacity = 4096 };
        Assert.Throws<ArgumentException>(() => new MemoryRegion("", options));
        Assert.Throws<ArgumentException>(() => new MemoryRegion("  ", options));
    }

    [Test]
    public void SingleProducerByteStream_InvalidArgs_ShouldThrow()
    {
        Assert.Throws<ArgumentException>(() => new SingleProducerByteStream("", 4096));
        Assert.Throws<ArgumentOutOfRangeException>(() => new SingleProducerByteStream("valid", 0));
        Assert.Throws<ArgumentOutOfRangeException>(() => new SingleProducerByteStream("valid", -1));
    }

    [Test]
    public void ConcurrentMessageQueue_InvalidArgs_ShouldThrow()
    {
        Assert.Throws<ArgumentException>(() => new ConcurrentMessageQueue("", 4, 64));
        Assert.Throws<ArgumentOutOfRangeException>(() => new ConcurrentMessageQueue("valid", 0, 64));
        Assert.Throws<ArgumentOutOfRangeException>(() => new ConcurrentMessageQueue("valid", 4, 0));
    }

    [Test]
    public void StructuredMemory_EmptyName_ShouldThrow()
    {
        var schema = new ReentrantTestSchema();
        Assert.Throws<ArgumentException>(() =>
            new StructuredMemory<ReentrantTestSchema>("", schema));
    }
    ...
    public void WriteBlob_ReadBlob_ShouldRoundTrip()
    {
        ...
        using var memory = new StructuredMemory<BlobSchema>("CovBoost_Blob", schema);
    ...
    {
        var schema = new BlobSchema();
        using var memory = new StructuredMemory<BlobSchema>("CovBoost_BlobEmpty", schema);
    ...
    {
        var schema = new BlobSchema();
        using var memory = new StructuredMemory<BlobSchema>("CovBoost_BlobMax", schema);
    ...
    {
        var schema = new BlobSchema();
        using var memory = new StructuredMemory<BlobSchema>("CovBoost_BlobOverflow", schema);
    ...
    {
        var schema = new BlobSchema();
        using var memory = new StructuredMemory<BlobSchema>("CovBoost_BlobWrongField", schema);
    ...
    {
        var schema = new BlobSchema();
        using var memory = new StructuredMemory<BlobSchema>("CovBoost_ReadBlobWrong", schema);
    ...
    {
        var schema = new BlobSchema();
        using var memory = new StructuredMemory<BlobSchema>("CovBoost_BlobOverwrite", schema);
    ...
    {
        var schema = new BlobSchema();
        using var memory = new StructuredMemory<BlobSchema>("CovBoost_BlobNoWrite", schema);
    ...
    public void WriteUtf8_ReadUtf8_ASCII_ShouldRoundTrip()
    {
        ...
        using var memory = new StructuredMemory<Utf8Schema>("CovBoost_Utf8Ascii", schema);
    ...
    {
        var schema = new Utf8Schema();
        using var memory = new StructuredMemory<Utf8Schema>("CovBoost_Utf8Unicode", schema);
    ...
    {
        var schema = new Utf8Schema();
        using var memory = new StructuredMemory<Utf8Schema>("CovBoost_Utf8Empty", schema);
    ...
    {
        var schema = new Utf8Schema();
        using var memory = new StructuredMemory<Utf8Schema>("CovBoost_Utf8Null", schema);
    ...
    {
        var schema = new Utf8Schema();
        using var memory = new StructuredMemory<Utf8Schema>("CovBoost_Utf8Overflow", schema);
    ...
    {
        var schema = new Utf8Schema();
        using var memory = new StructuredMemory<Utf8Schema>("CovBoost_Utf8WrongField", schema);
    ...
    {
        var schema = new Utf8Schema();
        using var memory = new StructuredMemory<Utf8Schema>("CovBoost_ReadUtf8Wrong", schema);
    ...
    {
        var schema = new Utf8Schema();
        using var memory = new StructuredMemory<Utf8Schema>("CovBoost_Utf8NoWrite", schema);
    ...
    public void WriteUtf8_LargeString_ShouldUseArrayPoolPath()
    {
        ...
        using var memory = new StructuredMemory<LargeUtf8Schema>("CovBoost_Utf8Large", schema);
    ...
    {
        var schema = new LargeUtf8Schema();
        using var memory = new StructuredMemory<LargeUtf8Schema>("CovBoost_Utf8LargeUni", schema);
    ...
    public void Utf8_MemoryEfficiency_ComparedToUtf16()
    {
        ...
        using var memory = new StructuredMemory<MixedStringSchema>("CovBoost_Utf8Efficiency", schema);
    ...
    public struct LargeUtf8Schema : IMemorySchema
    {
    ...
    public struct MixedStringSchema : IMemorySchema
    {
    ...
    public struct ReentrantTestSchema : IMemorySchema
    {
        public const string IntField = "IntValue";
    ...
    public struct LargeStringSchema : IMemorySchema
    {
    ...
    {
        var options = new MemoryRegionOptions { Capacity = 4096 };
        using var buffer = new MemoryRegion("CovR2_Stats", options);
    ...
    {
        var options = new MemoryRegionOptions { Capacity = 4096 };
        using var buffer = new MemoryRegion("CovR2_RLockTO", options);
    ...
    public void OrphanLock_TimeoutBased_ShouldDetect()
    {
        ...
        using var buffer = new MemoryRegion("CovR2_OrphanTO", options);
    ...
    {
        // Create first
        using var buf1 = new ConcurrentMessageQueue("CovR2_MpmcOpen", 4, 64, create: true);

        // Open existing with same params
        using var buf2 = new ConcurrentMessageQueue("CovR2_MpmcOpen", 4, 64, create: false);
    ...
    {
        using var buf1 = new ConcurrentMessageQueue("CovR2_MpmcMismatch", 4, 64, create: true);

        Assert.Throws<InvalidOperationException>(() =>
            new ConcurrentMessageQueue("CovR2_MpmcMismatch", 8, 64, create: false));
    }

    [Test]
    public void Mpmc_OpenExisting_SlotSizeMismatch_ShouldThrow()
    {
        using var buf1 = new ConcurrentMessageQueue("CovR2_MpmcSizeMismatch", 4, 64, create: true);

        Assert.Throws<InvalidOperationException>(() =>
            new ConcurrentMessageQueue("CovR2_MpmcSizeMismatch", 4, 128, create: false));
    }
    ...
    public void Mpmc_TryRead_SmallDestination_ShouldThrowAndPreserveMessage()
    {
        ...
        using var buffer = new ConcurrentMessageQueue("CovR2_MpmcTrunc", 4, 64);
    ...
    public void Mpmc_SpinExhaustion_Write_ShouldReturnFalse()
    {
        ...
        using var buffer = new ConcurrentMessageQueue("CovR2_MpmcSpinW", 2, 32);
    ...
    public void Mpmc_SpinExhaustion_Read_ShouldReturnZero()
    {
        ...
        using var buffer = new ConcurrentMessageQueue("CovR2_MpmcSpinR", 2, 32);
    ...
    {
        using var buffer = new SingleProducerByteStream("CovR2_Clear", 4096);
    ...
    {
        using var buffer = new SingleProducerByteStream("CovR2_EmptyWrite", 4096);
    ...
    {
        using var buffer = new SingleProducerByteStream("CovR2_EmptyRead", 4096);
    ...
    {
        using var buffer = new SingleProducerByteStream("CovR2_WaitWriteOK", 4096);
    ...
    // --- StructuredMemory additional ---

    [Test]
    public void Schema_Property_ShouldReturnSchema()
    {
        var schema = new ReentrantTestSchema();
        using var memory = new StructuredMemory<ReentrantTestSchema>("CovR2_SchemaProp", schema);
    ...
    {
        var schema = new ArraySchema();
        using var memory = new StructuredMemory<ArraySchema>("CovR2_ArrInvalidName", schema);
    ...
    {
        var schema = new ArraySchema();
        using var memory = new StructuredMemory<ArraySchema>("CovR2_ReadArrInvalidName", schema);
    ...
    {
        var schema = new ReentrantTestSchema();
        using var memory = new StructuredMemory<ReentrantTestSchema>("CovR2_StrInvalidName", schema);
    ...
    {
        var schema = new ReentrantTestSchema();
        using var memory = new StructuredMemory<ReentrantTestSchema>("CovR2_ReadStrInvalidName", schema);
    ...
    {
        var schema = new BlobSchema();
        using var memory = new StructuredMemory<BlobSchema>("CovR2_BlobInvalidName", schema);
    ...
    {
        var schema = new BlobSchema();
        using var memory = new StructuredMemory<BlobSchema>("CovR2_ReadBlobInvalidName", schema);
    ...
    {
        var schema = new Utf8Schema();
        using var memory = new StructuredMemory<Utf8Schema>("CovR2_Utf8InvalidName", schema);
    ...
    {
        var schema = new Utf8Schema();
        using var memory = new StructuredMemory<Utf8Schema>("CovR2_ReadUtf8InvalidName", schema);
    ...
    {
        var schema = new ArraySchema();
        using var memory = new StructuredMemory<ArraySchema>("CovR2_ArrWrongType", schema);
    ...
    {
        var schema = new ArraySchema();
        using var memory = new StructuredMemory<ArraySchema>("CovR2_ReadArrWrongType", schema);
    ...
    {
        var schema = new BlobSchema();
        using var memory = new StructuredMemory<BlobSchema>("CovR2_BlobLock", schema);
    ...
    {
        var schema = new BlobSchema();
        using var memory = new StructuredMemory<BlobSchema>("CovR2_ReadBlobLock", schema);
    ...
    {
        var schema = new Utf8Schema();
        using var memory = new StructuredMemory<Utf8Schema>("CovR2_Utf8Lock", schema);
    ...
    {
        var schema = new Utf8Schema();
        using var memory = new StructuredMemory<Utf8Schema>("CovR2_ReadUtf8Lock", schema);
