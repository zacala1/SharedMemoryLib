...
[TestFixture]
public class StructuredMemoryTests
{
    private const string TestBufferName = "TestBuffer_Strict";

    public struct TestSchema : IMemorySchema
    {
    ...
    public void Create_WithSchema_ShouldSucceed()
    {
        ...
        using var memory = new StructuredMemory<TestSchema>(TestBufferName + "_Create", schema);
    ...
    {
        var schema = new TestSchema();
        using var memory = new StructuredMemory<TestSchema>(TestBufferName + "_Int", schema);
    ...
    {
        var schema = new TestSchema();
        using var memory = new StructuredMemory<TestSchema>(TestBufferName + "_Double", schema);
    ...
    {
        var schema = new TestSchema();
        using var memory = new StructuredMemory<TestSchema>(TestBufferName + "_Array", schema);
    ...
    {
        var schema = new TestSchema();
        using var memory = new StructuredMemory<TestSchema>(TestBufferName + "_String", schema);
    ...
    {
        var schema = new TestSchema();
        using var memory = new StructuredMemory<TestSchema>(TestBufferName + "_EmptyString", schema);
    ...
    {
        var schema = new TestSchema();
        using var memory = new StructuredMemory<TestSchema>(TestBufferName + "_WriteLock", schema);
    ...
    {
        var schema = new TestSchema();
        using var memory = new StructuredMemory<TestSchema>(TestBufferName + "_ReadLock", schema);
    ...
    {
        var schema = new TestSchema();
        using var memory = new StructuredMemory<TestSchema>(TestBufferName + "_InvalidField", schema);
    ...
    {
        var schema = new TestSchema();
        using var memory = new StructuredMemory<TestSchema>(TestBufferName + "_WrongType", schema);
    ...
    {
        var schema = new TestSchema();
        using var memory = new StructuredMemory<TestSchema>(TestBufferName + "_LongString", schema);
    ...
    {
        var schema = new TestSchema();
        using var memory = new StructuredMemory<TestSchema>(TestBufferName + "_MultiField", schema);
    ...
    public void VersionedSchema_ShouldStoreVersion()
    {
        ...
        using var memory = new StructuredMemory<VersionedSchemaV1>(TestBufferName + "_Versioned", schema);
    ...
    public void VersionedSchema_SameVersion_ShouldWork()
    {
        ...
        using var memory2 = new StructuredMemory<VersionedSchemaV1>(uniqueName, schemaV1, create: false);
    ...
    public void VersionedSchema_BackwardCompatible_SameStructure_ShouldWork()
    {
        ...
        using var memory2 = new StructuredMemory<VersionedSchemaV1>(
    ...
    public void VersionedSchema_FullCompatibility_ShouldWorkForSameVersion()
    {
        ...
        using var memory1 = new StructuredMemory<VersionedSchemaV2>(uniqueName, schemaV2, create: true);
        memory1.Write(VersionedSchemaV2.IntField, 200);

        // Open with same schema in full compatibility mode
        using var memory2 = new StructuredMemory<VersionedSchemaV2>(
    ...
    public struct ExtendedTypeSchema : IMemorySchema
    {
    ...
    public void WriteRead_Guid_ShouldRoundTrip()
    {
        ...
        using var memory = new StructuredMemory<ExtendedTypeSchema>(TestBufferName + "_Guid", schema);
    ...
    {
        var schema = new ExtendedTypeSchema();
        using var memory = new StructuredMemory<ExtendedTypeSchema>(TestBufferName + "_GuidEmpty", schema);
    ...
    {
        var schema = new ExtendedTypeSchema();
        using var memory = new StructuredMemory<ExtendedTypeSchema>(TestBufferName + "_GuidArr", schema);
    ...
    {
        var schema = new ExtendedTypeSchema();
        using var memory = new StructuredMemory<ExtendedTypeSchema>(TestBufferName + "_DateTime", schema);
    ...
    {
        var schema = new ExtendedTypeSchema();
        using var memory = new StructuredMemory<ExtendedTypeSchema>(TestBufferName + "_DTMinMax", schema);
    ...
    {
        var schema = new ExtendedTypeSchema();
        using var memory = new StructuredMemory<ExtendedTypeSchema>(TestBufferName + "_DTArr", schema);
    ...
    {
        var schema = new ExtendedTypeSchema();
        using var memory = new StructuredMemory<ExtendedTypeSchema>(TestBufferName + "_TimeSpan", schema);
    ...
    {
        var schema = new ExtendedTypeSchema();
        using var memory = new StructuredMemory<ExtendedTypeSchema>(TestBufferName + "_TSMinMax", schema);
    ...
    {
        var schema = new ExtendedTypeSchema();
        using var memory = new StructuredMemory<ExtendedTypeSchema>(TestBufferName + "_TSNeg", schema);
    ...
    {
        var schema = new ExtendedTypeSchema();
        using var memory = new StructuredMemory<ExtendedTypeSchema>(TestBufferName + "_DateTimeOffset", schema);
    ...
    {
        var schema = new ExtendedTypeSchema();
        using var memory = new StructuredMemory<ExtendedTypeSchema>(TestBufferName + "_DTOOff", schema);
    ...
    {
        var schema = new ExtendedTypeSchema();
        using var memory = new StructuredMemory<ExtendedTypeSchema>(TestBufferName + "_Decimal", schema);
    ...
    {
        var schema = new ExtendedTypeSchema();
        using var memory = new StructuredMemory<ExtendedTypeSchema>(TestBufferName + "_DecMinMax", schema);
    ...
    {
        var schema = new ExtendedTypeSchema();
        using var memory = new StructuredMemory<ExtendedTypeSchema>(TestBufferName + "_DecPrec", schema);
    ...
    public struct CustomStructSchema : IMemorySchema
    {
    ...
    public struct ComplexStructSchema : IMemorySchema
    {
    ...
    public void WriteRead_CustomStruct_ShouldRoundTrip()
    {
        ...
        using var memory = new StructuredMemory<CustomStructSchema>(TestBufferName + "_CustomStruct", schema);
    ...
    {
        var schema = new CustomStructSchema();
        using var memory = new StructuredMemory<CustomStructSchema>(TestBufferName + "_StructZero", schema);
    ...
    {
        var schema = new CustomStructSchema();
        using var memory = new StructuredMemory<CustomStructSchema>(TestBufferName + "_StructNeg", schema);
    ...
    {
        var schema = new CustomStructSchema();
        using var memory = new StructuredMemory<CustomStructSchema>(TestBufferName + "_StructArray", schema);
    ...
    {
        var schema = new CustomStructSchema();
        using var memory = new StructuredMemory<CustomStructSchema>(TestBufferName + "_StructFull", schema);
    ...
    public void WriteRead_ComplexStruct_ShouldRoundTrip()
    {
        ...
        using var memory = new StructuredMemory<ComplexStructSchema>(TestBufferName + "_Complex", schema);
    ...
    {
        var schema = new ComplexStructSchema();
        using var memory = new StructuredMemory<ComplexStructSchema>(TestBufferName + "_ComplexArr", schema);
    ...
    public struct EnumSchema : IMemorySchema
    {
    ...
    public void WriteRead_IntEnum_ShouldRoundTrip()
    {
        ...
        using var memory = new StructuredMemory<EnumSchema>(TestBufferName + "_IntEnum", schema);
    ...
    {
        var schema = new EnumSchema();
        using var memory = new StructuredMemory<EnumSchema>(TestBufferName + "_IntEnumAll", schema);
    ...
    {
        var schema = new EnumSchema();
        using var memory = new StructuredMemory<EnumSchema>(TestBufferName + "_ByteEnum", schema);
    ...
    {
        var schema = new EnumSchema();
        using var memory = new StructuredMemory<EnumSchema>(TestBufferName + "_ByteEnumAll", schema);
    ...
    {
        var schema = new EnumSchema();
        using var memory = new StructuredMemory<EnumSchema>(TestBufferName + "_LongEnum", schema);
    ...
    {
        var schema = new EnumSchema();
        using var memory = new StructuredMemory<EnumSchema>(TestBufferName + "_ShortEnum", schema);
    ...
    {
        var schema = new EnumSchema();
        using var memory = new StructuredMemory<EnumSchema>(TestBufferName + "_UShortEnum", schema);
    ...
    {
        var schema = new ExtendedTypeSchema();
        using var memory = new StructuredMemory<ExtendedTypeSchema>(TestBufferName + "_ExtMulti", schema);
    ...
    {
        var schema = new ExtendedTypeSchema();
        using var memory = new StructuredMemory<ExtendedTypeSchema>(TestBufferName + "_ExtRepeat", schema);
    ...
    {
        var schema = new ExtendedTypeSchema();
        using var memory = new StructuredMemory<ExtendedTypeSchema>(TestBufferName + "_ConcGuid", schema);
    ...
    {
        var schema = new ExtendedTypeSchema();
        using var memory = new StructuredMemory<ExtendedTypeSchema>(TestBufferName + "_ConcDT", schema);
    ...
    {
        var schema = new ExtendedTypeSchema();
        using var memory = new StructuredMemory<ExtendedTypeSchema>(TestBufferName + "_ConcDec", schema);
    ...
    {
        var schema = new CustomStructSchema();
        using var memory = new StructuredMemory<CustomStructSchema>(TestBufferName + "_ConcStruct", schema);
    ...
    {
        var schema = new EnumSchema();
        using var memory = new StructuredMemory<EnumSchema>(TestBufferName + "_ConcEnum", schema);
    ...
    {
        var schema = new ExtendedTypeSchema();
        using var memory = new StructuredMemory<ExtendedTypeSchema>(TestBufferName + "_TypeMismatch", schema);
    ...
    {
        var schema = new ExtendedTypeSchema();
        using var memory = new StructuredMemory<ExtendedTypeSchema>(TestBufferName + "_TypeMismatch2", schema);
    ...
    public async Task AutoLock_ConcurrentGuid_WithoutExplicitLock_ShouldBeThreadSafe()
    {
        ...
        var schema = new ExtendedTypeSchema();
        using var memory = new StructuredMemory<ExtendedTypeSchema>(TestBufferName + "_AutoGuid", schema);
    ...
    {
        var schema = new ExtendedTypeSchema();
        using var memory = new StructuredMemory<ExtendedTypeSchema>(TestBufferName + "_AutoDec", schema);
    ...
    {
        var schema = new ExtendedTypeSchema();
        using var memory = new StructuredMemory<ExtendedTypeSchema>(TestBufferName + "_AutoDTO", schema);
    ...
    {
        var schema = new CustomStructSchema();
        using var memory = new StructuredMemory<CustomStructSchema>(TestBufferName + "_AutoStruct", schema);
    ...
    {
        using var memory = new StructuredMemory<TestSchema>(TestBufferName + "_AutoString", new TestSchema());
    ...
    {
        var schema = new ExtendedTypeSchema();
        using var memory = new StructuredMemory<ExtendedTypeSchema>(TestBufferName + "_AutoArr", schema);
    ...
    {
        var schema = new ExtendedTypeSchema();
        using var memory = new StructuredMemory<ExtendedTypeSchema>(TestBufferName + "_Reentrant", schema);
    ...
    {
        var schema = new TestSchema();
        var memory = new StructuredMemory<TestSchema>(TestBufferName + "_DisposeWrite", schema);
        memory.Dispose();
    ...
    {
        var schema = new TestSchema();
        var memory = new StructuredMemory<TestSchema>(TestBufferName + "_DisposeRead", schema);
        memory.Dispose();
    ...
    {
        var schema = new TestSchema();
        var memory = new StructuredMemory<TestSchema>(TestBufferName + "_DisposeStr", schema);
        memory.Dispose();
    ...
    {
        var schema = new TestSchema();
        var memory = new StructuredMemory<TestSchema>(TestBufferName + "_DisposeReadStr", schema);
        memory.Dispose();
    ...
    {
        var schema = new TestSchema();
        var memory = new StructuredMemory<TestSchema>(TestBufferName + "_DisposeLock", schema);
        memory.Dispose();
    ...
    {
        var schema = new TestSchema();
        var memory = new StructuredMemory<TestSchema>(TestBufferName + "_DisposeRLock", schema);
        memory.Dispose();
    ...
    {
        var schema = new TestSchema();
        var memory = new StructuredMemory<TestSchema>(TestBufferName + "_DoubleDispose", schema);
    ...
    {
        var schema = new TestSchema();
        using var memory = new StructuredMemory<TestSchema>(TestBufferName + "_LockDoubleDisp", schema);
    ...
    {
        var schema = new TestSchema();
        using var memory = new StructuredMemory<TestSchema>(TestBufferName + "_RLockDoubleDisp", schema);
    ...
    public void IPC_TwoInstances_SameMemory_ShouldShareData()
    {
        ...
        using var writer = new StructuredMemory<TestSchema>(sharedName, schema, create: true);
        using var reader = new StructuredMemory<TestSchema>(sharedName, schema, create: false);
    ...
    public void IPC_TwoInstances_ExtendedTypes_ShouldShareData()
    {
        ...
        using var writer = new StructuredMemory<ExtendedTypeSchema>(sharedName, schema, create: true);
        using var reader = new StructuredMemory<ExtendedTypeSchema>(sharedName, schema, create: false);
    ...
    public async Task IPC_ConcurrentAccess_WithLocks_ShouldWork()
    {
        ...
        using var instance1 = new StructuredMemory<TestSchema>(sharedName, schema, create: true);
        using var instance2 = new StructuredMemory<TestSchema>(sharedName, schema, create: false);
    ...
    public void IPC_ReaderFirst_ShouldFail()
    {
        ...
        Assert.That(() => new StructuredMemory<TestSchema>(sharedName, schema, create: false),
    ...
    public void AtomicBoundary_Long_ShouldNotAutoLock()
    {
        ...
        var schema = new TestSchema();
        using var memory = new StructuredMemory<TestSchema>(TestBufferName + "_AtomicLong", schema);
    ...
    public void AtomicBoundary_Double_ShouldNotAutoLock()
    {
        ...
        var schema = new TestSchema();
        using var memory = new StructuredMemory<TestSchema>(TestBufferName + "_AtomicDouble", schema);
    ...
    public async Task AtomicBoundary_Long_ConcurrentWithoutLock_ShouldWork()
    {
        ...
        var schema = new TestSchema();
        using var memory = new StructuredMemory<TestSchema>(TestBufferName + "_ConcLong", schema);
    ...
    public void SmallTypes_ShouldNotAutoLock()
    {
        ...
        var schema = new TestSchema();
        using var memory = new StructuredMemory<TestSchema>(TestBufferName + "_SmallTypes", schema);
    ...
    {
        var schema = new TestSchema();
        using var memory = new StructuredMemory<TestSchema>(TestBufferName + "_EmptyArr", schema);
    ...
    {
        var schema = new TestSchema();
        using var memory = new StructuredMemory<TestSchema>(TestBufferName + "_SingleArr", schema);
    ...
    {
        var schema = new TestSchema();
        using var memory = new StructuredMemory<TestSchema>(TestBufferName + "_PartialArrClear", schema);
    ...
    {
        var schema = new TestSchema();
        using var memory = new StructuredMemory<TestSchema>(TestBufferName + "_FullArr", schema);
    ...
    {
        var schema = new TestSchema();
        using var memory = new StructuredMemory<TestSchema>(TestBufferName + "_OverArr", schema);
    ...
    {
        var schema = new TestSchema();
        using var memory = new StructuredMemory<TestSchema>(TestBufferName + "_InvalidFieldR", schema);
    ...
    {
        var schema = new TestSchema();
        using var memory = new StructuredMemory<TestSchema>(TestBufferName + "_InvalidFieldS", schema);
    ...
    {
        var schema = new TestSchema();
        using var memory = new StructuredMemory<TestSchema>(TestBufferName + "_InvalidFieldRS", schema);
    ...
    {
        var schema = new TestSchema();
        using var memory = new StructuredMemory<TestSchema>(TestBufferName + "_NullStr", schema);
    ...
    {
        var schema = new TestSchema();
        using var memory = new StructuredMemory<TestSchema>(TestBufferName + "_LongStr", schema);
    ...
    {
        var schema = new TestSchema();
        using var memory = new StructuredMemory<TestSchema>(TestBufferName + "_MaxStr", schema);
    ...
    {
        var schema = new TestSchema();
        using var memory = new StructuredMemory<TestSchema>(TestBufferName + "_MaxStr1", schema);
    ...
    {
        var schema = new TestSchema();
        using var memory = new StructuredMemory<TestSchema>(TestBufferName + "_ArrScalar", schema);
    ...
    {
        var schema = new TestSchema();
        using var memory = new StructuredMemory<TestSchema>(TestBufferName + "_StrNonStr", schema);
    ...
    {
        var schema = new TestSchema();
        using var memory = new StructuredMemory<TestSchema>(TestBufferName + "_NonStrRead", schema);
    ...
    {
        var schema = new TestSchema();
        using var memory = new StructuredMemory<TestSchema>(TestBufferName + "_NonStrWrite", schema);
    ...
    {
        Assert.Throws<ArgumentException>(() =>
            new StructuredMemory<TestSchema>("", new TestSchema()));
    }
    ...
    public struct DuplicateFieldSchema : IMemorySchema
    {
        public IEnumerable<FieldDefinition> GetFields()
        {
    ...
    {
        Assert.Throws<ArgumentException>(() =>
            new StructuredMemory<DuplicateFieldSchema>(TestBufferName + "_DupField", new DuplicateFieldSchema()));
    }

    public struct EmptyFieldNameSchema : IMemorySchema
    {
        public IEnumerable<FieldDefinition> GetFields()
        {
    ...
    {
        Assert.Throws<ArgumentException>(() =>
            new StructuredMemory<EmptyFieldNameSchema>(TestBufferName + "_EmptyField", new EmptyFieldNameSchema()));
    }
    ...
    {
        var schema = new TestSchema();
        using var memory = new StructuredMemory<TestSchema>(TestBufferName + "_HasField", schema);
    ...
    {
        var schema = new TestSchema();
        using var memory = new StructuredMemory<TestSchema>(TestBufferName + "_NoField", schema);
    ...
    {
        var schema = new TestSchema();
        using var memory = new StructuredMemory<TestSchema>(TestBufferName + "_FieldNames", schema);
    ...
    {
        var schema = new TestSchema();
        using var memory = new StructuredMemory<TestSchema>(TestBufferName + "_LockTimeout", schema);
    ...
    public struct Size8Schema : IMemorySchema
    {
    ...
    public struct Size9Schema : IMemorySchema
    {
        public const string Field = "Field";
    ...
    public void Struct_Exactly8Bytes_ShouldNotAutoLock()
    {
        ...
        using var memory = new StructuredMemory<Size8Schema>(TestBufferName + "_8Byte", schema);
    ...
    public async Task Struct_Over8Bytes_ConcurrentWithoutExplicitLock_ShouldAutoLock()
    {
        ...
        using var memory = new StructuredMemory<Size9Schema>(TestBufferName + "_9Byte", schema);
    ...
    {
        var schema = new TestSchema();
        using var memory = new StructuredMemory<TestSchema>(TestBufferName + "_SpecialFloat", schema);
    ...
    {
        var schema = new TestSchema();
        using var memory = new StructuredMemory<TestSchema>(TestBufferName + "_EmptyStr", schema);
    ...
    {
        var schema = new TestSchema();
        using var memory = new StructuredMemory<TestSchema>(TestBufferName + "_Unicode", schema);
    ...
    {
        var schema = new TestSchema();
        using var memory = new StructuredMemory<TestSchema>(TestBufferName + "_NullChar", schema);
