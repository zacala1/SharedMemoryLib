...
public class MemoryRegionTests
{
    ...
    public void Create_WithValidOptions_ShouldSucceed()
    {
        ...
        using var buffer = new MemoryRegion(TestBufferName + "_Create", options);
    ...
    public void Write_Read_SmallData_ShouldRoundTrip()
    {
        ...
        using var buffer = new MemoryRegion(TestBufferName + "_SmallData", options);
    ...
    public void Write_Read_LargeData_ShouldUseSimd()
    {
        ...
        using var buffer = new MemoryRegion(TestBufferName + "_LargeData", options);
    ...
    {
        var options = new MemoryRegionOptions { Capacity = 4096 };
        using var buffer = new MemoryRegion(TestBufferName + "_Async", options);
    ...
    {
        var options = new MemoryRegionOptions { Capacity = 4096 };
        using var buffer = new MemoryRegion(TestBufferName + "_WriteLock", options);
    ...
    {
        var options = new MemoryRegionOptions { Capacity = 4096 };
        using var buffer = new MemoryRegion(TestBufferName + "_ReadLock", options);
    ...
    {
        var options = new MemoryRegionOptions { Capacity = 4096 };
        using var buffer = new MemoryRegion(TestBufferName + "_GetMemory", options);
    ...
    {
        var options = new MemoryRegionOptions { Capacity = 4096 };
        using var buffer = new MemoryRegion(TestBufferName + "_Offsets", options);
    ...
    public void Write_OutOfBounds_ShouldThrow()
    {
        ...
        using var buffer = new MemoryRegion(TestBufferName + "_OutOfBounds", options);
    ...
    {
        var options = new MemoryRegionOptions { Capacity = 100 };
        using var buffer = new MemoryRegion(TestBufferName + "_ReadOutOfBounds", options);
    ...
    {
        var options = new MemoryRegionOptions { Capacity = 1024 * 1024 };
        using var buffer = new MemoryRegion(TestBufferName + "_Concurrent", options);
    ...
    {
        var options = new MemoryRegionOptions { Capacity = 4096 };
        using var buffer = new MemoryRegion(TestBufferName + "_Checksum", options);
    ...
    {
        var options = new MemoryRegionOptions { Capacity = 4096 };
        using var buffer = new MemoryRegion(TestBufferName + "_ChecksumDiff", options);
    ...
    public void VerifyIntegrity_WhenDataUnchanged_ShouldReturnTrue()
    {
        ...
        using var buffer = new MemoryRegion(TestBufferName + "_Integrity", options);
    ...
    public void VerifyIntegrity_WhenEnabledWithoutStoredChecksum_ShouldReturnFalse()
    {
        ...
        using var buffer = new MemoryRegion(TestBufferName + "_IntegrityNoChecksum", options);
    ...
    {
        var options = new MemoryRegionOptions { Capacity = 4096 };
        using var buffer = new MemoryRegion(TestBufferName + "_LockOwner", options);
    ...
    public void IsWriteLockOrphaned_WhenLockHeldByCurrentProcess_ShouldReturnFalse()
    {
        ...
        using var buffer = new MemoryRegion(TestBufferName + "_NotOrphan", options);
    ...
    {
        var options = new MemoryRegionOptions { Capacity = 4096 };
        using var buffer = new MemoryRegion(TestBufferName + "_ForceRelease", options);
    ...
    public void OnDataWritten_WhenEventsEnabled_ShouldFire()
    {
        ...
        using var buffer = new MemoryRegion(TestBufferName + "_WriteEvent", options);

        MemoryRegionEventArgs? receivedArgs = null;
        ...
        Assert.That(receivedArgs!.EventType, Is.EqualTo(MemoryRegionEventType.DataWritten));
    ...
    public void OnDataWritten_WhenEventsDisabled_ShouldNotFire()
    {
        ...
        using var buffer = new MemoryRegion(TestBufferName + "_NoEvent", options);
    ...
    public void VerifyIntegrity_WhenDataCorrupted_ShouldReturnFalse()
    {
        ...
        using var buffer = new MemoryRegion(TestBufferName + "_Corrupt", options);
    ...
    public void UpdateChecksum_ThenVerify_ShouldSucceed()
    {
        ...
        using var buffer = new MemoryRegion(TestBufferName + "_UpdateChecksum", options);
    ...
    {
        var options = new MemoryRegionOptions { Capacity = 4096 };
        using var buffer = new MemoryRegion(TestBufferName + "_ZeroWrite", options);
    ...
    {
        var options = new MemoryRegionOptions { Capacity = 4096 };
        using var buffer = new MemoryRegion(TestBufferName + "_ZeroRead", options);
    ...
    public void Write_AtCapacityBoundary_ShouldSucceed()
    {
        ...
        using var buffer = new MemoryRegion(TestBufferName + "_Boundary", options);
    ...
    {
        var options = new MemoryRegionOptions { Capacity = 4096 };
        var buffer = new MemoryRegion(TestBufferName + "_ConcurrentDispose", options);
    ...
    {
        var options = new MemoryRegionOptions { Capacity = 4096 };
        var buffer = new MemoryRegion(TestBufferName + "_AfterDispose", options);
        buffer.Dispose();
    ...
    {
        var options = new MemoryRegionOptions { Capacity = 4096 };
        using var buffer = new MemoryRegion(TestBufferName + "_Timeout", options);
