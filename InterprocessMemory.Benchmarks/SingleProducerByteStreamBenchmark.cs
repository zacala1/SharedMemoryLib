...
public class SingleProducerByteStreamBenchmark
{
    private SingleProducerByteStream _buffer = null!;
    ...
    public void Setup()
    {
        _buffer = new SingleProducerByteStream("Benchmark_Circular", 16 * 1024 * 1024);
...
[MemoryDiagnoser]
[SimpleJob(RuntimeMoniker.Net80)]
public class SingleProducerByteStreamProducerConsumerBenchmark
{
    private SingleProducerByteStream _buffer = null!;
    ...
    public void Setup()
    {
        _buffer = new SingleProducerByteStream("Benchmark_SPSC", 64 * 1024 * 1024);
