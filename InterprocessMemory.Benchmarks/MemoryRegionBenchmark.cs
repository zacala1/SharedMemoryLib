...
public class MemoryRegionBenchmark
{
    ...
    public void Setup()
    {
        ...
        _buffer = new MemoryRegion("Benchmark_Buffer", options);
...
[MemoryDiagnoser]
[SimpleJob(RuntimeMoniker.Net80)]
public class MemoryRegionThroughputBenchmark
{
    private MemoryRegion _buffer = null!;
    ...
    public void Setup()
    {
        ...
        _buffer = new MemoryRegion("Benchmark_Throughput", options);
